...
export const site = {
  ...
  projects: {
    ...
    cards: [
      ...
      {
        name: "RiftLab Personal AI OS",
        tag: "claude plugin",
        featured: true,
        desc: "An installable Claude plugin I built and ship publicly. It gives Claude a set of skills and a team of thinking agents, then sets up your own context so every session knows who you are. Built for my course, open for anyone to install.",
        stats: [
          { value: "7", label: "skills" },
          { value: "11", label: "agents" },
          { value: "2-step", label: "install" },
        ],
        cta: { label: "github.com/sash-rift/riftlab-personal-os", href: "https://github.com/sash-rift/riftlab-personal-os" },
        soon: false,
      },
      {
        name: "Rift Dispatch",
